...
class Provider extends events.EventEmitter {
  constructor(issuer, setup = {}) {
    ...
    if (conf.features.tokenIntegrity) {
      instance(this).BaseToken = models.checksumToken(this);
    }
  ...
  initialize({
    adapter, clients = [], keystore, integrity,
  } = {}) {
    if (this.initialized) throw new Error('already initialized');

    return initializeKeystore.call(this, keystore)
      .then(() => initializeIntegrity.call(this, integrity))
